...
#### Note : Plotting plot4.R of the House hold Power Consumption Data
...
globalReactivePower <- as.numeric(data_df$Global_reactive_power)
voltage <- as.numeric(data_df$Voltage)
